...
$(function () {
    ...
    $(document).ready(function () {
        $('.slick-carousel').on('beforeChange', function (event, slick, currentSlide, nextSlide) {
          $('.slide__title').removeClass('animate'); // Remove any existing animation class
        });
      
        $('.slick-carousel').on('afterChange', function (event, slick, currentSlide) {
          $('.slick-active .slide__title').addClass('animate'); // Add animation to active slide
        });
      });

      $(document).ready(function () {
        $('.slick-carousel').on('beforeChange', function () {
          $('.slide__title').removeClass('animate__animated animate__slideInLeft');
        });
      
        $('.slick-carousel').on('afterChange', function () {
          $('.slick-active .slide__title').addClass('animate__animated animate__slideInLeft');
        });
      });
